...
public class TouchTransformImageView extends TransformImageView
	...
	private static final String TAG = TouchTransformImageView.class.getSimpleName();
...
//--------------------------------------------------------------------------------
	 ...
	 * @param context
	 */
	public TouchTransformImageView(final Context context) {
		this(context, null, 0);
	}
	 ...
	 * @param attrs
	 */
	public TouchTransformImageView(final Context context, final AttributeSet attrs) {
	 ...
	 * @param defStyle
	 */
	public TouchTransformImageView(final Context context, final AttributeSet attrs, final int defStyle) {
		...
		mDelegater = new TouchViewTransformer(this) {
			...
			public void onInit() {
				...
				superSetScaleType(ImageView.ScaleType.CENTER_INSIDE);
...
// ImageViewをoverride
	...
	public void setScaleType(final ImageView.ScaleType scaleType) {
		...
		Log.w(TAG, "setScaleType: ignore this parameter on TouchTransformImageView, fixed to ScaleType.MATRIX.");
	}
