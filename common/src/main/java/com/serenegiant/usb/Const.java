...
public interface Const {
	...
	public static final int USB_REQ_VENDER_DEVICE_SET = (USB_DIR_OUT | USB_TYPE_VENDOR | USB_RECIP_DEVICE);				// 0x40
	public static final int USB_REQ_VENDER_DEVICE_GET = (USB_DIR_IN | USB_TYPE_VENDOR | USB_RECIP_DEVICE);				// 0xc0
	public static final int USB_REQ_VENDER_INTERFACE_SET = (USB_DIR_OUT | USB_TYPE_VENDOR | USB_RECIP_INTERFACE);		// 0x41
	public static final int USB_REQ_VENDER_INTERFACE_GET = (USB_DIR_IN | USB_TYPE_VENDOR | USB_RECIP_INTERFACE);		// 0xc1
	public static final int USB_REQ_VENDER_ENDPOINT_SET = (USB_DIR_OUT | USB_TYPE_VENDOR | USB_RECIP_ENDPOINT);			// 0x42
	public static final int USB_REQ_VENDER_ENDPOINT_GET = (USB_DIR_IN | USB_TYPE_VENDOR | USB_RECIP_ENDPOINT);			// 0xc2
