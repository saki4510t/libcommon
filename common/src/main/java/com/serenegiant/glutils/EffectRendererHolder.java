...
//--------------------------------------------------------------------------------
	...
	private static final String FRAGMENT_SHADER_EXT_GRAY_ES3
...
//--------------------------------------------------------------------------------
	...
	private static final String FRAGMENT_SHADER_GRAY_EXT_REVERSE_ES3
...
//--------------------------------------------------------------------------------
	...
	private static final String FRAGMENT_SHADER_EXT_BIN_ES3
		= String.format(FRAGMENT_SHADER_BIN_BASE_ES3,
			HEADER_OES_ES3, SAMPLER_OES, "1.0, 1.0, 1.0");

	private static final String FRAGMENT_SHADER_EXT_BIN_YELLOW_ES3
		= String.format(FRAGMENT_SHADER_BIN_BASE_ES3,
			HEADER_OES_ES3, SAMPLER_OES, "1.0, 1.0, 0.0");

	private static final String FRAGMENT_SHADER_EXT_BIN_GREEN_ES3
		= String.format(FRAGMENT_SHADER_BIN_BASE_ES3,
...
//--------------------------------------------------------------------------------
	...
	private static final String FRAGMENT_SHADER_EXT_BIN_REVERSE_ES3
		= String.format(FRAGMENT_SHADER_BIN_REVERSE_BASE_ES3,
			HEADER_OES_ES3, SAMPLER_OES, "1.0, 1.0, 1.0");

	private static final String FRAGMENT_SHADER_EXT_BIN_REVERSE_YELLOW_ES3
		= String.format(FRAGMENT_SHADER_BIN_REVERSE_BASE_ES3,
			HEADER_OES_ES3, SAMPLER_OES, "1.0, 1.0, 0.0");

	private static final String FRAGMENT_SHADER_EXT_BIN_REVERSE_GREEN_ES3
		= String.format(FRAGMENT_SHADER_BIN_REVERSE_BASE_ES3,
			HEADER_OES_ES3, SAMPLER_OES, "0.0, 1.0, 0.0");
...
//--------------------------------------------------------------------------------
	...
	private static final String FRAGMENT_SHADER_EXT_EMPHASIZE_RED_YELLOWS_ES3
...
//--------------------------------------------------------------------------------
	...
	private static final String FRAGMENT_SHADER_EXT_EMPHASIZE_RED_YELLOW_WHITE_ES3
...
//--------------------------------------------------------------------------------
	...
	private static final String FRAGMENT_SHADER_EXT_EMPHASIZE_YELLOW_WHITE_ES3
