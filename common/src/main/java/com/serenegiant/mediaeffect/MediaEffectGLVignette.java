...
import static com.serenegiant.gl.ShaderConst.FRAGMENT_SHADER_VIGNETTE_ES2;
...
public class MediaEffectGLVignette extends MediaEffectGLBase {
	...
	private static final String TAG = "MediaEffectGLVignette";

	public MediaEffectGLVignette() {
		super(new MediaEffectGLColorAdjustDrawer(FRAGMENT_SHADER_VIGNETTE_ES2));
		setParameter(1f);
	}
