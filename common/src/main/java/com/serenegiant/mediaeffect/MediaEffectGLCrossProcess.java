...
import static com.serenegiant.gl.ShaderConst.FRAGMENT_SHADER_CROSS_PROCESS_ES2;
...
public class MediaEffectGLCrossProcess extends MediaEffectGLBase {
	...
	public MediaEffectGLCrossProcess() {
		super(new MediaEffectGLColorAdjustDrawer(FRAGMENT_SHADER_CROSS_PROCESS_ES2));
	}
}
