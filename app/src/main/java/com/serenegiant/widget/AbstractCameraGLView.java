...
//********************************************************************************
	...
	private static final class CameraSurfaceRenderer
		...
		private final WeakReference<AbstractCameraGLView> mWeakParent;
		...
		public CameraSurfaceRenderer(final AbstractCameraGLView parent) {
			if (DEBUG) Log.v(TAG, "CameraSurfaceRenderer:");
			mWeakParent = new WeakReference<AbstractCameraGLView>(parent);
...
//			if (DEBUG) Log.i(TAG, "onSurfaceCreated:Gl extensions: " + extensions);
			...
			final AbstractCameraGLView parent = mWeakParent.get();
			if (parent != null) {
...
//				parent.requestRender();
	...
	private static final class CameraThread extends Thread {
    	...
    	public CameraThread(final AbstractCameraGLView parent) {
			super("Camera thread");
    		mWeakParent = new WeakReference<AbstractCameraGLView>(parent);
    	}
...
//					}
		...
		private final void setRotation(final Camera.Parameters params) {
			...
			if (BuildCheck.isAPI17()) {
				rotation = parent.getDisplay().getRotation();
			} else {
