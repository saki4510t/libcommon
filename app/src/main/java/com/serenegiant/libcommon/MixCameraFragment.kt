...
class MixCameraFragment : AbstractCameraFragment() {
	...
	companion object {
		...
		private val TAG = MixCameraFragment::class.java.simpleName

		fun newInstance(): MixCameraFragment {
			val fragment = MixCameraFragment()
			val args = Bundle()
