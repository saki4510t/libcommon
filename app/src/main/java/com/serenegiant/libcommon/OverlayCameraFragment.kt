...
class OverlayCameraFragment : AbstractCameraFragment() {
	...
	companion object {
		...
		private val TAG = OverlayCameraFragment::class.java.simpleName

		fun newInstance(): OverlayCameraFragment {
			val fragment = OverlayCameraFragment()
			val args = Bundle()
