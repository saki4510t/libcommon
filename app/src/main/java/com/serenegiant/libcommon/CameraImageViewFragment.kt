...
class CameraImageViewFragment : AbstractCameraFragment() {
	...
	companion object {
		...
		private val TAG = CameraImageViewFragment::class.java.simpleName

		fun newInstance(): CameraImageViewFragment {
			val fragment = CameraImageViewFragment()
			val args = Bundle()
