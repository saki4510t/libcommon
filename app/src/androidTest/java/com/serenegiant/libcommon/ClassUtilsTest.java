...
public class ClassUtilsTest {
	...
	public void primitiveClassTest() {
		...
		assertEquals(boolean.class, getPrimitiveClass(Boolean.valueOf("true")));
		assertEquals(Boolean.TYPE, getPrimitiveClass(false));
		assertEquals(Boolean.TYPE, getPrimitiveClass(Boolean.valueOf("false")));
		assertEquals(boolean.class, getPrimitiveClass(false));
		assertEquals(boolean.class, getPrimitiveClass(Boolean.valueOf("false")));

		assertEquals(Byte.TYPE, getPrimitiveClass(Byte.MIN_VALUE));
		assertEquals(Byte.TYPE, getPrimitiveClass(Byte.MAX_VALUE));
		assertEquals(Byte.TYPE, getPrimitiveClass((byte)0));
		assertEquals(Byte.TYPE, getPrimitiveClass((byte)0x20));
		assertEquals(Byte.TYPE, getPrimitiveClass(Byte.valueOf("32")));
		assertEquals(byte.class, getPrimitiveClass(Byte.MIN_VALUE));
		assertEquals(byte.class, getPrimitiveClass(Byte.MAX_VALUE));
		assertEquals(byte.class, getPrimitiveClass((byte)0));
		assertEquals(byte.class, getPrimitiveClass((byte)0x20));
		assertEquals(byte.class, getPrimitiveClass(Byte.valueOf("32")));

		assertEquals(Short.TYPE, getPrimitiveClass(Short.MIN_VALUE));
		assertEquals(Short.TYPE, getPrimitiveClass(Short.MAX_VALUE));
		assertEquals(Short.TYPE, getPrimitiveClass((short)0));
		assertEquals(Short.TYPE, getPrimitiveClass((short)0x20));
		assertEquals(Short.TYPE, getPrimitiveClass(Short.valueOf("32")));
		assertEquals(short.class, getPrimitiveClass(Short.MAX_VALUE));
		assertEquals(short.class, getPrimitiveClass(Short.MAX_VALUE));
		assertEquals(short.class, getPrimitiveClass((short)0));
		assertEquals(short.class, getPrimitiveClass((short)0x20));
		assertEquals(short.class, getPrimitiveClass(Short.valueOf("32")));

		assertEquals(Integer.TYPE, getPrimitiveClass(Integer.MIN_VALUE));
		assertEquals(Integer.TYPE, getPrimitiveClass(Integer.MAX_VALUE));
		assertEquals(Integer.TYPE, getPrimitiveClass(0));
		assertEquals(Integer.TYPE, getPrimitiveClass(123));
		assertEquals(Integer.TYPE, getPrimitiveClass(Integer.valueOf("123")));
		assertEquals(int.class, getPrimitiveClass(Integer.MIN_VALUE));
		assertEquals(int.class, getPrimitiveClass(Integer.MAX_VALUE));
		assertEquals(int.class, getPrimitiveClass(0));
		assertEquals(int.class, getPrimitiveClass(123));
		assertEquals(int.class, getPrimitiveClass(Integer.valueOf("123")));

		assertEquals(Long.TYPE, getPrimitiveClass(Long.MIN_VALUE));
		assertEquals(Long.TYPE, getPrimitiveClass(Long.MAX_VALUE));
		assertEquals(Long.TYPE, getPrimitiveClass(0L));
		assertEquals(Long.TYPE, getPrimitiveClass(123L));
		assertEquals(Long.TYPE, getPrimitiveClass(Long.valueOf("123")));
		assertEquals(long.class, getPrimitiveClass(Long.MIN_VALUE));
		assertEquals(long.class, getPrimitiveClass(Long.MAX_VALUE));
		assertEquals(long.class, getPrimitiveClass(0L));
		assertEquals(long.class, getPrimitiveClass(123L));
		assertEquals(long.class, getPrimitiveClass(Long.valueOf("123")));

		assertEquals(Float.TYPE, getPrimitiveClass(-Float.MIN_VALUE));
		assertEquals(Float.TYPE, getPrimitiveClass(Float.MIN_VALUE));
		assertEquals(Float.TYPE, getPrimitiveClass(-Float.MAX_VALUE));
		assertEquals(Float.TYPE, getPrimitiveClass(Float.MAX_VALUE));
		assertEquals(Float.TYPE, getPrimitiveClass(Float.MIN_NORMAL));
		assertEquals(Float.TYPE, getPrimitiveClass(-0.0f));
		assertEquals(Float.TYPE, getPrimitiveClass(0.0f));
		assertEquals(Float.TYPE, getPrimitiveClass(-1.0f));
		assertEquals(Float.TYPE, getPrimitiveClass(1.0f));
		assertEquals(Float.TYPE, getPrimitiveClass(Float.valueOf("1.2")));
		assertEquals(float.class, getPrimitiveClass(-Float.MIN_VALUE));
		assertEquals(float.class, getPrimitiveClass(Float.MIN_VALUE));
		assertEquals(float.class, getPrimitiveClass(-Float.MAX_VALUE));
		assertEquals(float.class, getPrimitiveClass(Float.MAX_VALUE));
		assertEquals(float.class, getPrimitiveClass(Float.MIN_NORMAL));
		assertEquals(float.class, getPrimitiveClass(-0.0f));
		assertEquals(float.class, getPrimitiveClass(0.0f));
		assertEquals(float.class, getPrimitiveClass(-1.0f));
		assertEquals(float.class, getPrimitiveClass(1.0f));
		assertEquals(float.class, getPrimitiveClass(Float.valueOf("1.2")));

		assertEquals(Double.TYPE, getPrimitiveClass(-Double.MIN_VALUE));
		assertEquals(Double.TYPE, getPrimitiveClass(Double.MIN_VALUE));
		assertEquals(Double.TYPE, getPrimitiveClass(-Double.MAX_VALUE));
		assertEquals(Double.TYPE, getPrimitiveClass(Double.MAX_VALUE));
		assertEquals(Double.TYPE, getPrimitiveClass(Double.MIN_NORMAL));
		assertEquals(Double.TYPE, getPrimitiveClass(-0.0));
		assertEquals(Double.TYPE, getPrimitiveClass(0.0));
		assertEquals(Double.TYPE, getPrimitiveClass(-1.0));
		assertEquals(Double.TYPE, getPrimitiveClass(1.0));
		assertEquals(Double.TYPE, getPrimitiveClass(Double.valueOf("1.2")));
		assertEquals(double.class, getPrimitiveClass(-Double.MIN_VALUE));
		assertEquals(double.class, getPrimitiveClass(Double.MIN_VALUE));
		assertEquals(double.class, getPrimitiveClass(-Double.MAX_VALUE));
		assertEquals(double.class, getPrimitiveClass(Double.MAX_VALUE));
		assertEquals(double.class, getPrimitiveClass(Double.MIN_NORMAL));
		assertEquals(double.class, getPrimitiveClass(-0.0));
		assertEquals(double.class, getPrimitiveClass(0.0));
